 ...
 * @LastEditTime: 2020-07-02 22:40:50
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \My-JavaScript-Study\React Study\day20\src\store\api\index.js
 */
import FetchX from "src/utils/fetchX";
const baseUrl = "http://127.0.0.1:8899/api/v1";

const fetchX = new FetchX(baseUrl);

export const fetchAticleInfoById = (action) =>
  fetchX.get('/article/find', {
